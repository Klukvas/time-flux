...
export const THEME_OPTIONS: {
...
}[] = [
  {
    ...
    titleKey: 'settings.theme_light',
  },
  {
    value: 'dark',
    icon: 'M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z',
    titleKey: 'settings.theme_dark',
  },
  {
    value: 'system',
    icon: 'M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z',
    titleKey: 'settings.theme_system',
  },
];
...
export function Sidebar({ highlightedItem }: SidebarProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`border-t border-edge ${collapsed ? 'p-2' : 'px-4 py-3'}`}
      >
        {/* Theme switcher */}
        <div
        ...
        {/* Language switcher */}
        <div
          className={`mt-2 flex items-center ${collapsed ? 'flex-col gap-1' : 'gap-1'}`}
        >
