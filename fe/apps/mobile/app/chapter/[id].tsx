  ...
  return (
    <>
      ...
      >
        ...
        {details.totalDays > 0 && (
          <View
            style={[styles.statsRow, { backgroundColor: tokens.colors.bgCard }]}
          >
        ...
        {details.moodStats && details.moodStats.length > 0 && (
          <View
            style={[styles.section, { backgroundColor: tokens.colors.bgCard }]}
          >
            <Text
              style={[
                styles.sectionTitle,
              ...
              return (
                ...
                >
                  <View style={styles.periodTop}>
                    <Text
                      style={[styles.periodDate, { color: tokens.colors.text }]}
                    >
