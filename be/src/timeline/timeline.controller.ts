...
export class TimelineController {
  ...
  @Get()
  @ApiOperation({
    summary: 'Get vertical timeline (events + days for a date range)',
  })
  ...
  async getTimeline(
    ...
    return this.timelineService.getTimeline(user.sub, query, user.timezone);
  }

  @Get('week')
  @ApiOperation({
    summary: 'Get week view (7 days with events for a specific week)',
  })
  ...
  async getWeekTimeline(
    ...
    return this.timelineService.getWeekTimeline(user.sub, query, user.timezone);
  }
}
